INSERT INTO staging.jobs (
    ...
    job_industry, job_type, job_level, job_description, job_excerpt, 
    location, latitude, longitude, remote_type, workplace, 
    salary_min, salary_max, salary_currency, company_size, company_type, 
    tech_stack, filter_tags, has_visa_sponsorship, language_requirements, 
    published_at, last_update, ingested_ts, staging_ts
)
SELECT 
    id::TEXT AS job_id,
